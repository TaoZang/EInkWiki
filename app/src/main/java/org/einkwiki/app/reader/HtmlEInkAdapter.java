...
public final class HtmlEInkAdapter {
    private static final String INJECTION = "<meta name=\"viewport\" "
            ...
            + "@font-face{font-family:'EInkWiki Serif';font-style:normal;font-weight:100 900;"
            + "font-display:block;src:url('/__einkwiki/NotoSerifSC.ttf') format('truetype');}"
            + ":root{color-scheme:light;scroll-behavior:auto!important;}"
            + "html,body{margin:0!important;padding:0!important;background:#fff!important;"
            + "color:#000!important;font-family:'EInkWiki Serif',serif!important;font-size:18px!important;"
            ...
            + "h1,h2,h3,h4,h5,h6{font-family:'EInkWiki Serif',serif!important;color:#000!important;"
            + "font-weight:600!important;"
            + "line-height:1.3!important;break-after:avoid!important;margin-top:1.35em!important;}"
            + "h1{font-size:1.35em!important;border-bottom:2px solid #000!important;}"
            + "h2{font-size:1.2em!important;border-bottom:1px solid #000!important;}"
